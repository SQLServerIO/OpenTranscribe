...
- Support for multiple LLM providers (vLLM, OpenAI, Ollama, Google, OpenRouter)
...
**Configuration:**
- Set `LLM_PROVIDER` in .env file (vllm, openai, ollama, google, openrouter)
...
**Deployment Options:**
- **Cloud Providers**: Use `.env` configuration with external providers (OpenAI, Google, OpenRouter, etc.)
